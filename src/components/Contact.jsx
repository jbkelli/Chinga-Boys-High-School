  ...
  return (
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    info@chingaboyshigh.ac.ke<br />
                    admissions@chingaboyshigh.ac.ke
                  </p>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-cyan-600 text-white p-3 rounded-full hover:bg-cyan-700 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M20 10C20 4.477 15.523 0 10 0S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.128 20 14.991 20 10z" clipRule="evenodd"/>
                  </svg>
                </a>
                <a href="#" className="bg-cyan-400 text-white p-3 rounded-full hover:bg-cyan-500 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent outline-none transition-colors resize-vertical"
                  placeholder="Please share your questions, comments, or inquiries..."
                ></textarea>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-cyan-600 text-white px-8 py-4 rounded-lg hover:bg-cyan-700 transition-colors font-semibold text-lg"
                >
                  Send Message
                </button>
              </div>
        ...
        {/* Map Placeholder */}
        <div className="mt-20">
          <h3 className="text-3xl font-bold text-gray-800 mb-8 text-center">Find Us</h3>
          <div className="bg-gray-200 rounded-2xl h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-500">Chinga Boys High School Location</p>
            </div>
          </div>
        </div>
      </div>
